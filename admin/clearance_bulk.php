<?php
    ...
    foreach($list_student_id as $i => $student_id){
        ...
        if($clearance_exist->num_rows > 0){
            ...
            $query2 = "UPDATE clearance SET clearance_status = '$clearance_status' WHERE student_id = '$student_id' AND clearance_progress_id = $clearance_progress_id AND clearance_type_id = $clearance_type_id";
